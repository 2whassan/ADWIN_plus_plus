...
public class SnapshotThreadExecutorADWINWrapper implements ADWINInterface {
    ...
    public SnapshotThreadExecutorADWINWrapper(double delta,  Class<? extends Histogram> histogramClass, Class<? extends ADWIN> adwinClass,
