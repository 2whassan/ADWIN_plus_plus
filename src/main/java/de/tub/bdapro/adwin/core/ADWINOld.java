...
//			temp = this.tail;
    ...
    private class ListItem {
        ...
        protected int MAXBUCKETS = ADWINOld.MAXBUCKETS;
...
//			 object.
    ...
    private static final int mintMinWinLength = 5;
    ...
    public boolean setInput(double intEntrada, double delta) {
        ...
        if (mintTime % mintClock == 0 && getWidth() > mintMinimLongitudWindow) {
            ...
            while (blnReduceWidth) // Diference
            {
                ...
                int i = lastBucketRow;
                // Solange verschiebe buckets to w0 bis !blnExit && cursor != null
                do {
